    ...
    protected abstract class AbstractUnsafe implements Unsafe {
        ...
        public final void register(EventLoop eventLoop, final ChannelPromise promise) {
            ...
            if (eventLoop.inEventLoop()) {
                ...
                try {
                    ...
                    //调用 AbstractUnsafe#closeForcibly() 方法，强制关闭 Channel
                    closeForcibly();
                    //调用 CloseFuture#setClosed() 方法，通知 closeFuture 已经关闭
        ...
        private void register0(ChannelPromise promise) {
            try {
                ...
                //调用 DefaultChannelPipeline#invokeHandlerAddedIfNeeded() 方法，触发 ChannelInitializer 执行，进行 Handler 初始化。
                //这里就是我们自己写的 ServerBootstrap 对 Channel 设置的 ChannelInitializer 将被执行，进行 Channel 的 Handler 的初始化。
